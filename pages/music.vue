...
<template>
    <div class="max-w-md min-h-screen mx-auto p-[20px]">
        <div class="flex flex-row items-center justify-center gap-3">
            ...
            <h1 class="text-[18px] sm:text-[22px] font-serif font-bold dark:text-white ">DiskMall-音乐搜索下载</h1>
        </div>
        ...
        <div class="space-y-2 mt-5" v-if="kwData && kwData.length > 0">
            ...
            <div class="text-purple-500" v-if="searchLoading">DiskMall，正在努力搜索中...</div>
            <ul class="space-y-2">
